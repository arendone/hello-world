...
/*   Updated: 2022/01/24 19:27:54 by arendon-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	deal_key(int key, t_info *fractal)
{
	...
	if (key == 53 || key == 12)
		...
		printf("mandelbrot %lu", sizeof(fractal));
		//cuadrado(fractal, 600, 10, 0x0000FF00); SEGMENTATION FAUL
	else if (key == 38)
		printf("julia");
		//cuadrado(fractal, 600, 100, 0x000000FF);
	return (0);
}
/*
