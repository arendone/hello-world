...
int main(void)
{
	...
	value=ft_printf("%-.1d LmTjflbkJ %018X %-5c %-.0u %0*x as8T %-2c.\n", -2147483647, 0, 'G', 2147483647, -10, -2147483647, '\0');
    ft_printf("%d \n", value);
    value=printf("%-.1d LmTjflbkJ %018X %-5c %-.0u %0*x as8T %-2c.\n", -2147483647, 0, 'G', 2147483647, -10, -2147483647, '\0');
    ft_printf("%d \n", value);
	value=ft_printf("Quiero imprimir el numero %*d, %4.*d y %4.*d.\n", 13, (int)-2147483648, 3, 5, -3, 5);
    ft_printf("%d \n", value);
    value=printf("Quiero imprimir el numero %*d, %4.*d y %4.*d.\n", 13, (int)-2147483648, 3, 5, -3, 5);
	ft_printf("%d \n", value);
    ...
    ft_printf("%d \n", value);
    value=ft_printf("%05% ....% %...%5%\n");
    ft_printf("%d \n", value);
    value=printf("%05% ....% %...%5%\n");
    ft_printf("%d \n", value);
	value=ft_printf("%09.5% ....% %...%5%\n");
    ft_printf("%d \n", value);
    value=printf("%09.5% ....% %...%5%\n");
    ft_printf("%d \n", value);
